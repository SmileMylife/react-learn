...
class ReplySheet extends React.Component {
    state = {
        data: [],
        cols: 1,
        pickerValue: [],
    ...
    render() {
        ...
        return (<div>
            ...
            <NavBar
                mode="dark"
                icon={<Icon style={{marginLeft: "30px"}} type="left" onClick={this.back}/>}>返单</NavBar>
            ...
            <List style={{backgroundColor: 'white'}}>
                ...
                <Picker data={COMMON_WORDS} cols={1} {...getFieldProps('district2')}>
                    <List.Item arrow="horizontal" className="list-item-custom">处理结果</List.Item>
                </Picker>
                ...
                <Picker data={COMMON_WORDS} cols={1} {...getFieldProps('district2')}>
                    <List.Item arrow="horizontal" className="list-item-custom">是否批量投诉</List.Item>
                </Picker>

                <Picker data={COMMON_WORDS} cols={1} {...getFieldProps('district2')}>
                    <List.Item arrow="horizontal" className="list-item-custom">是否无理由投诉</List.Item>
                </Picker>
                ...
                {/*派转工作组*/}
                <List.Item className="list-item-custom">责任原因</List.Item>
                <TreeSelect
                    showSearch
                    style={{width: '100%'}}
...
export const REPLY_SHEET = createForm()(ReplySheet);
